...
<br>We can be certain that non-delivered orders directly corelate to negative reviews. Another main factor is delivery times, ACG has committed to 21 business days to deliver an order, however we can see that there has been a total of 845 late deliveries on top of the 491 which were not delivered, the average score is negative (-1.35) for these late orders.
